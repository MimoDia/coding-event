...
class Colorbox extends FormatterBase implements ContainerFactoryPluginInterface {
   ...
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, $settings, $label, $view_mode, $third_party_settings, RendererInterface $renderer, FormatterInterface $thumbnail_formatter, FormatterInterface $audio_formatter, $colorbox_attachment) {
